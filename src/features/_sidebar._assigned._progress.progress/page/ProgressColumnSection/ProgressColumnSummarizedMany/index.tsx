import type { ConciseSession, SyllabusWithSessions } from "@/features/_sidebar._assigned._progress.progress/types"
...
type FilterSyllabusArrayProps = {
    conciseSyllabusArray: SyllabusWithSessions[]
    checkCondition: (conciseSession: ConciseSession) => boolean
}
const filterSyllabusArray = ({
    conciseSyllabusArray,
    checkCondition,
}: FilterSyllabusArrayProps): SyllabusWithSessions[] => {
